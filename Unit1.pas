...
begin
  ...
  form5.Memo1.Lines.add('- Año de creacion del Software: 2021');
  ...
  form5.memo2.lines.add('Software diseñado de forma especial '+
                        'para un emprendimiento de accesorios,  '+
                        'el cual ayudará a organizar las ventas  '+
